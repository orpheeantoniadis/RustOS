...
interfaçant la méthode \mintinline{rust}{write_fmt} appliquée a la structure
statique représentant l'écran et la macro \mintinline{rust}{format_args} convertie
...
toute modification de la variable \mintinline{rust}{TIMER} sera \mintinline{rust}{unsafe}
...
de la structure statique \mintinline{rust}{TIMER}. La fonction \mintinline{rust}{halt}
