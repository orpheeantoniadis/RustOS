...
\begin{figure}[!h]
  \centering
  \includegraphics[scale=0.85]{images/ex_base_limit.png}
...
adresse linéaire en utilisant une \acrshort{gdt} ou plusieurs \acrshort{ldt}.
Si la pagination (dont on parlera plus tard) est activée, l'adresse linéaire
et convertie en adresse physique. Toute cette mécanique est décrite dans la figure
\ref{addr_translation}. La segmentation permet de faire la convertion d'adresse
logique en adresse linéaire et est obligatoire en mode protégé (32-bits).
