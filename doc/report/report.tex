...
\mintinline{c}{SECTION} va dire au linker où placer les parties du code. Par exemple, 
la section \mintinline{c}{.text} contiendra le code et la section \mintinline{c}{.data}
